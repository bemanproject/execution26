...
template <typename CallbackFun>
inplace_stop_callback(::beman::execution26::inplace_stop_token, CallbackFun) -> inplace_stop_callback<CallbackFun>;
} // namespace beman::execution26
...
inline auto beman::execution26::inplace_stop_source::stop_requested() const noexcept -> bool { return this->stopped; }

inline constexpr auto beman::execution26::inplace_stop_source::stop_possible() noexcept -> bool { return true; }
...
inline beman::execution26::inplace_stop_callback<CallbackFun>::inplace_stop_callback(
    ::beman::execution26::inplace_stop_token token, Init&& init)
