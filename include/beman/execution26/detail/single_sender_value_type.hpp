...
template <typename Sender, typename Env>
    requires requires {
        typename ::beman::execution26::value_types_of_t<Sender, Env, ::std::decay_t, ::std::type_identity_t>;
    }
struct single_sender_value_type_helper<Sender, Env> {
    using type = ::beman::execution26::value_types_of_t<Sender, Env, ::std::decay_t, ::std::type_identity_t>;
};
...
template <typename Sender, typename Env>
    requires(not requires {
            ...
            (not::std::same_as<::std::variant<::std::tuple<>>,
                               ::beman::execution26::value_types_of_t<Sender, Env, ::std::tuple, ::std::variant>>) &&
            requires {
                typename ::beman::execution26::
                    value_types_of_t<Sender, Env, ::beman::execution26::detail::decayed_tuple, ::std::type_identity_t>;
            }
struct single_sender_value_type_helper<Sender, Env> {
    using type = ::beman::execution26::
        value_types_of_t<Sender, Env, ::beman::execution26::detail::decayed_tuple, ::std::type_identity_t>;
};
